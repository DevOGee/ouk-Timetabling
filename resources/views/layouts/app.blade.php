...
<head>
    ...
    <title>@yield('title') - Open University of Kenya</title>
    ...
    <style>
        :root {
            ...
            --topbar-text: #1e293b;
            --topbar-hover: #f1f5f9;
            --topbar-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03);
        ...
        h1, h2, h3, h4, h5, h6, .menu-title, .active-session-badge {
    ...
    <div class="main-content-wrapper">
        ...
        <header class="top-bar">
            <div class="d-flex align-items-center gap-2">
                <button class="btn btn-link text-dark d-lg-none p-1" id="mobileMenuBtn" style="font-size:1.4rem;">
                    <i class="bi bi-list"></i>
                </button>
                <a href="{{ route('dashboard') }}" class="topbar-logo">
                    <img src="{{ asset('ouk-logo.png') }}" alt="OUK Logo" style="height:36px;">
                </a>
            </div>
            ...
            <div class="d-flex align-items-center gap-2">
                @php
                    ...
                    $hasImg = false; $imgUrl = null;
                    if ($u->image_path) {
                        foreach ([$u->image_path, 'storage/'.$u->image_path] as $p) {
                            if (file_exists(public_path($p))) { $imgUrl = asset($p); $hasImg = true; break; }
                        }
                    }
                @endphp
                ...
                <div class="dropdown">
                    <a class="d-flex align-items-center gap-2 text-decoration-none" href="#"
                       data-bs-toggle="dropdown" aria-expanded="false" style="cursor:pointer;">
                        <div class="user-avatar" style="background:var(--secondary);color:#fff;font-weight:700;">
                            @if($hasImg && $imgUrl)
                        ...
                        <div class="d-none d-md-block lh-1">
                            ...
                            <div class="text-muted" style="font-size:12px;">
                                {{ $u->roles->first() ? ucfirst($u->roles->first()->name) : 'User' }}
                            </div>
                        </div>
