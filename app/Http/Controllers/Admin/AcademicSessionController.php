...
class AcademicSessionController extends Controller
{
    ...
    public function show(AcademicSession $academicSession)
    {
        ...
        } else if (request()->has('school_id') && request('school_id') !== 'all') {
        ...
        $programmes->getCollection()->transform(function($programme) use ($academicSession) {
        ...
        if (request()->ajax() && request()->has('tab')) {
            ...
            if ($tab === 'timetables') {
                return response()->json([
                    ...
                    'pagination' => (string) $programmes->appends(request()->except('page'))->links()
                ]);
